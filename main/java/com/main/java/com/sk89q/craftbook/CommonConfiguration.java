...
public class CommonConfiguration extends BaseConfiguration {
    ...
    public boolean enableMechaisms;
    ...
    public void load() {
        ...
        enableCircuits = getBoolean("enable-circuits", true);
        enableMechaisms = getBoolean("enable-mechanisms", true);
        enableVehicles = getBoolean("enable-vehicles", true);
    }
}
