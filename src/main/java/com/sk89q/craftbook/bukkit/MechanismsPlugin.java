...
public class MechanismsPlugin extends BaseBukkitPlugin {
    ...
    public void onEnable() {
        ...
        createDefaultConfiguration("mechanisms-config.yml", false);
    ...
    private void setupSelfTriggered(MechanicManager manager) {
        ...
        BaseBukkitPlugin.logger.info("CraftBook: Enumerating chunks for INSTANCE-triggered components...");
        ...
        BaseBukkitPlugin.logger.info("CraftBook: " + numChunks + " chunk(s) for " + numWorlds + " world(s) processed " +
                "" + "(" + Math
